      ...
      <div>
        {!user ? (
          ...
          <div className="flex flex-col gap-5">
            ...
            <button onClick={() =>signOut(auth)} className="flex justify-center items-center gap-2 text-2xl md:text-[16px] p-1 bg-zinc-700 rounded  transition hover:bg-zinc-900">
              <BiSolidDoorOpen />
